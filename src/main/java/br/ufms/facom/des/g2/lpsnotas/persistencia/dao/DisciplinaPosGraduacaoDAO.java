...
public class DisciplinaPosGraduacaoDAO extends Dao<DisciplinaPosGraduacao> {
    ...
    @Override
    protected DisciplinaPosGraduacao resultSetToObjet(ResultSet rs) {
    ...
    @Override
    public DisciplinaPosGraduacao save(DisciplinaPosGraduacao disciplinaPosGraduacao) {
        try {
            try {
            ...
            new Exception(String.format("Houve um erro na tentativa de salvar o objeto %s", disciplinaPosGraduacao.exibir()));
        }
        return disciplinaPosGraduacao;
    }
